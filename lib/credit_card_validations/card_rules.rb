  ...
  module CardRules
    ...
    self.brands = {
            ...
            mastercard: {
                ...
                options: {brand_name: 'Master Card'}
            },
            ...
            amex: {
                ...
                options: {brand_name: 'American Express'}
            },
            ######## other brands ########
            diners: {
                rules: [
                ...
                options: {brand_name: 'Diners Club'}
            },
            ...
            rupay: {
                rules: [
                    {length: [16], prefixes: ['6061', '6062', '6063', '6064', '6065', '6066', '6067', '6068', '6069', '607', '608']}
                ],
                options: {
                       skip_luhn: true
                   },
